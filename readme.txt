...
- instrucciones para arrancar el servidor en puerto 3001 (con solo iniciar api.js y prender el xampp ya funciona todo para probar en postman)

LISTA USUARIOS
POR DEFAULT SON TODOS NO-ADMIN (0)